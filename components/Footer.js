  ...
  return (
    ...
    <div className="container py-16 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col px-2 sm:px-6 lg:px-8 max-w-screen-xl">
      <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        ...
        <h2 className="text-white rounded-lg py-1 mt-2 uppercase font-semibold text-sm">Web Apps &middot; Mobile Apps</h2>
      </div>
      <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav className="list-none mb-10">
            <li className="mb-2">
            <Link href="/" className="text-base text-gray-300 font-medium hover:text-white">
            Home
          </Link>
            </li>
            <li className="mb-2">
    ...
    <div>
      <div className="container mx-auto py-4 flex flex-wrap flex-col sm:flex-row px-2 sm:px-6 lg:px-8 max-w-screen-xl">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
          ...
          <a className="ml-6 text-gray-500" href="https://twitter.com/msahajwani" target="_blank" rel="noreferrer">
            <svg
