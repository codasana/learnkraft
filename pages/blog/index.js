      ...
      <div className="p-4 md:w-1/3">
              ...
              <div className="p-6">
                  ...
                  <h1>
                    <Link
                      href={post.url}
                      className="title-font text-xl font-semibold text-gray-900 mb-3">
  ...
  return (
    <Layout>
      <Head>
        ...
        <section className="text-gray-600 body-font overflow-hidden bg-gradient-to-b from-zinc-100 to-zinc-100">
        ...
        <section className="text-gray-600 body-font overflow-hidden bg-gradient-to-b from-zinc-100">
