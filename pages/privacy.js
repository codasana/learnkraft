...
export default function Home() {
  return (
    <Layout title="Privacy Policy - Learn Kraft">

      {/*  Page content */}
      <main className="flex-grow">
        {/*  Page sections */}
        <div className="max-w-3xl mx-auto my-16 prose">
...
<li>
<p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Learn Kraft</p>
</li>
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Learn Kraft Info Solutions LLP, B1502, Glen Gate, House of Hiranandani, Devi Nagar, Bengaluru - 560092.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to learn Kraft, accessible from <a href="https://learnkraft.com" target="_blank">https://learnkraft.com</a></p>
</li>
<li>
...
<h1>Lawful Basis</h1>
<p>Pursuant to the General Data Protection Regulation (“GDPR”), if you are a resident of the European Economic Area (“EEA”), 
we process your personal information under the following lawful bases:</p>
...
<h2>Cookies</h2>
<p>A cookie is a small amount of information that’s downloaded to your computer or device when you visit our Site. We use a number of different cookies, including functional, performance, advertising, and social media or content cookies. Cookies make your browsing experience better by allowing the website to remember your actions and preferences (such as login and region selection). This means you don’t have to re-enter this information each time you return to the site or browse from one page to another. Cookies also provide information on how people use the website, for instance whether it’s their first time visiting or if they are a frequent visitor. We use  cookies to optimize your experience on our Site and to provide our services.</p>
