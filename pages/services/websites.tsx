...
const Home: NextPage = () => {
  ...
  let meta = {
    title: "Website Development Services - Learn Kraft",
  ...
  return (
    <Layout title="Website Development Services">
            <Head>
      ...
      <section className="text-gray-600 body-font bg-gradient-to-b from-blue-100"> {/*   */}
        <div className="container mx-auto flex py-16 md:flex-row flex-col items-center px-2 sm:px-6 lg:px-8 max-w-screen-xl">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            {<h2 className="text-amber-500 bg-blue-50 rounded-sm px-2 py-1 mb-2 uppercase font-semibold text-base">Website Development</h2>}
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-extrabold text-gray-900" style={{lineHeight:1.25}}>Bespoke marketing and ecommerce 
              <span className="text-brand-600"> websites</span>
            </h1>
            <p className="mb-8 leading-relaxed text-lg text-gray-800">Our UX designers and developers work together to build easy-to-navigate and unique websites to help you attract and engage with your customers using WordPress and Jamstack technologies.</p>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-20 mx-auto">
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center bg-brand-500 px-8 py-10 rounded-xl">
            ...
            We pride ourselves on providing high-quality website development services that are tailored to the unique needs of each of our clients. Our team of experienced developers and designers work closely with our clients to ensure that every aspect of their website is designed to meet their specific requirements. We offer a wide range of website development services, including custom website design, e-commerce solutions, and content management systems. Our goal is to help our clients establish a strong online presence and achieve their business objectives through the power of cutting-edge web technology. We are committed to delivering results-driven solutions that exceed our clients' expectations and help them succeed in the highly competitive online marketplace.
            </p>
