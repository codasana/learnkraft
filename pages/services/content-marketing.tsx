...
const Home: NextPage = () => {
  ...
  let meta = {
    ...
    description:'We provide scalable content marketing services to help you boost traffic and generate leads. This includes developing your content marketing strategy, and writing targeted content for every need including blogs.',
      ...
      <section className="text-gray-600 body-font bg-gradient-to-b from-blue-100"> {/*   */}
        <div className="container mx-auto flex py-16 md:flex-row flex-col items-center px-2 sm:px-6 lg:px-8 max-w-screen-xl">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            {<h2 className="text-amber-500 bg-blue-50 rounded-sm px-2 py-1 mb-2 uppercase font-semibold text-base">Content Marketing</h2>}
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-extrabold text-gray-900" style={{lineHeight:1.25}}>Results oriented 
              <br className="hidden lg:inline-block" />
              <span className="text-brand-600"> content marketing</span>
            </h1>
          ...
          <div className="flex items-center justify-center">
            <img className="object-cover object-center rounded rounded-lg" alt="hero" src="/images/services/content-marketing.png" />
          </div>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-20 mx-auto">
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center bg-brand-500 px-8 py-10 rounded-xl">
            ...
            It can be challenging for businesses to develop a content marketing plan and continuously produce content. Conducting research, identifying topics, hiring writers, and managing the entire content generation process all involve time and money. Learn Kraft provides a great content solution to assist you in taking your content marketing to the next level. Tell us your goals, and we'll put your content creation on autopilot. We will assist you with developing an executable content strategy, performing subject and keyword research, developing a content calendar, and producing your content with the finest writers based on your goals.
            </p>
